...
void succI(int *i) {
    /*
    nilai i sditerima kemudian ditambah 1
...
void predI(int *i) {
    /*
    nilai i akan diterima kemudian dikurangi 1
    dan dikembalikan sbg parameter output
    */
    *i = *i - 1;
}
void succC(char *c) {
    /*
    nilai c akan diterima kemudian ditambah 1 dan dikembalikan sbg parameter output
    */
    *c = *c + 1;
}
void predC(char *c) {
    /*
    nilai c akan diterima kemudian dikurangi 1 dan dikembalikan sbg parameter output
    */
    *c = *c - 1;
}
...
void geser(int *TT, void (*f)(int *)) {
    ...
    *TT: Parameter input output bertipe integer
    (*f) (int *): parameter input output betipe void yang memiliki parameter (int *)
    */
    int i;
    printf(" dalam geser \n");
    for (i = 0; i < N; i++) {
...
void geser(char *TT, void (*f)(char *)) {
    /*
    *TT: Parameter input output bertipe integer
    (*f) (char *): parameter input output betipe void yang memiliki parameter (char *)
    */
    int i;
    printf(" dalam geser \n");
    for (i = 0; i < N; i++) {
